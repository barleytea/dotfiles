...
公式インストールスクリプトで導入（mise tasks として定義済み）：

```bash
# safe-chain 本体のインストール
mise run safe-chain-install
# 展開先: ~/.safe-chain/
...
mise の tasks 定義（`darwin/home-manager/mise/default.nix`）：
